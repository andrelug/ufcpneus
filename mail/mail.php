...
if(isset($_POST['email'])) {
	...
	$transport = Swift_SmtpTransport::newInstance('njly-tx5m.accessdomain.com', 25, 'tls' )
	  ->setUsername('contato@bhpneusmultimarcas.com.br')     
	  ->setPassword('Bhpneus1!')
	  ;
	...
	$message = Swift_Message::newInstance('Contato - Website')
	  ->setFrom(array($_POST['email'] => $_POST['name']))
	  ->setTo(array('contato@bhpneusmultimarcas.com.br' => 'BHpneus'))->setBody($messageText);
//                           ^                    ^
